    ...
    <div class="col-md-12">
       <form role="form" action="{{url('admin/searchCoupon')}}" method="get"  enctype="multipart/form-data">   
           <div id="datatable-buttons_filter" class="dataTables_filter" sytle="position:relative">
            ...
            <input type="search" id="search" class="form-control form-control-sm" name="keyword" placeholder="Tìm kiếm theo mã" aria-controls="datatable-buttons" style= "height:35px; width: 400px;padding-left: 35px;"></div>
        </form>
    </div>
</div>
<div class="row">
