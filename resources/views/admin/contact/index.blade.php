        ...
        <form role="form" action="{{url('admin/searchContact')}}" method="get"  enctype="multipart/form-data">   
            <div class="row">
                <div class="col-5">
                    ...
                    <input type="search" id="search" class="form-control form-control-sm" name="keyword" placeholder="Tìm kiếm tên hoặc số điện thoại" aria-controls="datatable-buttons" style= "height:39px;padding-left: 35px;">
                </div>
                <div class="col-3">
