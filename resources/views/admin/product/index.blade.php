        ...
        <form role="form" action="{{url('admin/searchProduct')}}" method="get"  enctype="multipart/form-data">
            <div class="row">
                <div class="col-5">
                    ...
                    <input type="search" id="search" class="form-control form-control-sm" name="keyword" placeholder="Tìm kiếm tên" aria-controls="datatable-buttons" style= "height:39px;padding-left: 35px;">
                </div>
                <div class="col-2">
                ...
                <div class="col-2">
                    <select class="custom-select mb-2" name="vendor_id">
                        ...
                        @foreach ($vendorsFilter as $vendorFilter)
                            <option value="{{$vendorFilter->id}}" >{{$vendorFilter->name}}</option>
                        @endforeach
                    </select>
                </div>
                <div class="col-1">
